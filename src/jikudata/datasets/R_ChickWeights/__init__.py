...
class R_ChickWeights(_Dataset):
    '''
    Chick weights by feed supplement; six groups with UNEQUAL n, which is
    what separates eta squared from omega squared.
    effectsize also reports eta2 = 0.541685465674, omega2 = 0.502884665323.
    ...
    def _set_attrs(self):
        ...
        self.notes = 'R built-in dataset "chickwts". Expected values computed with R\'s "effectsize" package (1.0.3, R 4.6.1) -- a cross-implementation reference, not a published figure. Generator: effectsize_reference.R.'
